...
use app\assets\Yii2WeblogAdminAsset;
use yii\widgets\Menu;
use yii\helpers\Url;

Yii2WeblogAdminAsset::register($this);
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
...
<div class="wrap">
        ...
        if (Yii::$app->user->role == 'author') {
                $items = [
                        [
                                'label' => '<i class="fa fa-dashboard"></i> <span class="sb-menu-label"> &nbsp;' . Yii::t('app', 'Dashboard2') . '</span>',
                                'url' => ['site/dashboard'],
                ...
                $items = [
                        ...
                        [
                                ...
                                'items' => [
                                        ...
                                        [
                                                ...
                                                'url' => ['taxonomy/'],
                                                'active' => in_array($this->context->route, array('taxonomy/index', 'taxonomy/view', 'taxonomy/create', 'taxonomy/update')) ? true : false
                                        ],
                                        [
                                                'label' => Yii::t('app', 'Create Post'),
                                                'url' => ['post/create'],
                        ...
                        [
                                'label' => '<i class="fa fa-archive"></i> <span class="sb-menu-label"> &nbsp;' . Yii::t('app', 'Pages') . '</span>',
                                'url' => ['post/page'],
                                'items' => [
                                        [
                                                'label' => Yii::t('app', 'Pages'),
                                                'url' => ['post/page'],
                                                'active' => in_array($this->context->route, array('post/page', 'post/pview', 'post/pupdate')) ? true : false
                                        ],
                                        [
                                                'label' => Yii::t('app', 'Create Page'),
                                                'url' => ['post/pcreate'],
                                                'active' => in_array($this->context->route, array('post/pcreate')) ? true : false
                                        ]
                                ]
                        ],
                        [
                        ...
                        [
                                ...
                                'items' => [
                                        ...
                                        [
                                                ...
                                                'url' => ['menu/index'],
                                                'active' => in_array($this->context->route, array('menu/index', 'menu/view', 'menu/create', 'menu/update')) ? true : false,
                                        ],
                                ]
                        ],
                        [
                                'label' => '<i class="fa fa-wrench"></i> <span class="sb-menu-label"> &nbsp;' . Yii::t('app', 'Options') . '</span>',
                                'url' => ['option/site'],
                                'active' => in_array($this->context->route, array('option/site')) ? true : false,
                        ],
                        [
...
<footer class="footer">
    <div class="container">
        <p class="pull-left">&copy; enagape.org 2017</p>
