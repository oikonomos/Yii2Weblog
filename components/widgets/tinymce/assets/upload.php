...
<div id="pop_wrap">
    ...
    <?php
    $uri = str_replace('upload.php', '', $_SERVER['REQUEST_URI']);
    ?>
    
    <!-- container -->
	<div id="pop_container2" class="pop_container2">
        <form id="editor_upimage" name="editor_upimage" action="<?php echo $uri ?>acceptor.php" method="post" enctype="multipart/form-data">
        <div id="pop_content2">
