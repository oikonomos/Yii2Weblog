...
<div class="auth-assignment-index">
    ...
    <p>
        ...
        <?= Html::a(Yii::t('app', 'Delete Selected Auth Assignments'), 'javascript:void(0);', ['id'=>'delete-items', 'class' => 'btn btn-danger']) ?>
    </p>
<?php Pjax::begin(); ?>
    <?= GridView::widget([
...
", Yii::t('app', 'Select items you would delete.'), Yii::t('app', 'If you would delete, you do not recover them. Do you delete all selected items?'), Url::toRoute(['assignment/deleteall']), Yii::$app->request->csrfToken ) );
?>
